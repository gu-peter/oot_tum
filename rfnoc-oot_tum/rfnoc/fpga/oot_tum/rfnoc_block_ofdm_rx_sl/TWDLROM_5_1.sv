// -------------------------------------------------------------
// 
// File Name: /home/peter/git/ofdm-de-modulation-and-channel-estimation/IntroductionToCustomOFDMExample/hdl_rx/introOFDMReceiver/rxsl_TWDLROM_5_1.sv
...
// -------------------------------------------------------------
// 
// Module: rxsl_TWDLROM_5_1
// Source Path: introOFDMReceiver/OFDM Receiver/OFDM Demodulation/OFDM Demodulator/dsphdl.FFT/rxsl_TWDLROM_5_1
// Hierarchy Level: 4
// Model version: 10.1
// 
// -------------------------------------------------------------
...
module rxsl_TWDLROM_5_1
          ...
          (  input logic clk,
             ...
             output logic signed [15:0] twdl_5_1_re  /* sfix16_En14 */,
             output logic signed [15:0] twdl_5_1_im  /* sfix16_En14 */);
  ...
  logic twdl45Reg;
  logic signed [15:0] twdl_5_1_re_1;  /* sfix16_En14 */
  logic signed [15:0] twdl_5_1_im_1;  /* sfix16_En14 */
  ...
  always_comb begin
    ...
    if (dout_4_1_vld && (Radix22TwdlMapping_cnt > 6'b111011)) begin
      Radix22TwdlMapping_phase_next = Radix22TwdlMapping_phase + 2'b01;
    end
    if (dout_4_1_vld) begin
      Radix22TwdlMapping_cnt_next = Radix22TwdlMapping_cnt + 6'b000100;
    end
