// -------------------------------------------------------------
// 
// File Name: /home/peter/git/ofdm-de-modulation-and-channel-estimation/IntroductionToCustomOFDMExample/hdl_rx/introOFDMReceiver/rxsl_SDFCommutator4.sv
...
// -------------------------------------------------------------
// 
// Module: rxsl_SDFCommutator4
// Source Path: introOFDMReceiver/OFDM Receiver/OFDM Demodulation/OFDM Demodulator/dsphdl.FFT/rxsl_RADIX22FFT_SDF2_4/rxsl_SDFCommutator4
// Hierarchy Level: 5
// Model version: 10.1
// 
// -------------------------------------------------------------
...
module rxsl_SDFCommutator4
          (  input logic clk,
             ...
             input logic signed [19:0] xf_re  /* sfix20_En15 */,
             input logic signed [19:0] xf_im  /* sfix20_En15 */,
             input logic xf_vld,
             input logic signed [19:0] dinf_re  /* sfix20_En15 */,
             input logic signed [19:0] dinf_im  /* sfix20_En15 */,
             input logic dinf_vld,
             input logic signed [19:0] btf1_re  /* sfix20_En15 */,
             input logic signed [19:0] btf1_im  /* sfix20_En15 */,
             input logic signed [19:0] btf2_re  /* sfix20_En15 */,
             input logic signed [19:0] btf2_im  /* sfix20_En15 */,
             input logic btfout_vld,
             output logic signed [19:0] wrData_re  /* sfix20_En15 */,
             output logic signed [19:0] wrData_im  /* sfix20_En15 */,
             output logic [3:0] wrAddr  /* ufix4 */,
             output logic wrEnb,
  ...
  logic signed [19:0] SDFCummutator_out_re_next;  /* sfix20_En15 */
  logic signed [19:0] SDFCummutator_out_im_next;  /* sfix20_En15 */
  logic SDFCummutator_out_vld_next;
  logic [3:0] SDFCummutator_wrAddr_reg_next;  /* ufix4 */
  logic [2:0] SDFCummutator_wrState_next;  /* ufix3 */
  logic [1:0] SDFCummutator_mem_btf_switch_next;  /* ufix2 */
  logic [3:0] SDFCummutator_rdCnt_next;  /* ufix4 */
  logic signed [19:0] SDFCummutator_wrData_re_reg_next;  /* sfix20_En15 */
  logic signed [19:0] SDFCummutator_wrData_im_reg_next;  /* sfix20_En15 */
  logic SDFCummutator_wrEnb_reg_next;
  logic signed [19:0] SDFCummutator_wrXData_re_reg_next;  /* sfix20_En15 */
  logic signed [19:0] SDFCummutator_wrXData_im_reg_next;  /* sfix20_En15 */
  ...
  logic signed [19:0] wrData_re_1;  /* sfix20_En15 */
  logic signed [19:0] wrData_im_1;  /* sfix20_En15 */
  logic [3:0] wrAddr_1;  /* ufix4 */
  logic wrEnb_1;
  logic signed [19:0] xData_re;  /* sfix20_En15 */
  logic signed [19:0] xData_im;  /* sfix20_En15 */
  logic [2:0] wrXAddr;  /* ufix3 */
  logic wrXEnb;
  logic [2:0] rdXAddr;  /* ufix3 */
  logic xX_vld;
  logic signed [19:0] dout0_re;  /* sfix20_En15 */
  logic signed [19:0] dout0_im;  /* sfix20_En15 */
  logic dout0_vld;
  logic signed [19:0] xX_re;  /* sfix20_En15 */
  logic signed [19:0] xX_im;  /* sfix20_En15 */
  logic signed [19:0] SDFOutmux_btf2Pipe_re;  /* sfix20 */
  logic signed [19:0] SDFOutmux_btf2Pipe_im;  /* sfix20 */
  logic SDFOutmux_btfPipe_vld;
  logic signed [19:0] SDFOutmux_btf2Pipe_re_next;  /* sfix20_En15 */
  logic signed [19:0] SDFOutmux_btf2Pipe_im_next;  /* sfix20_En15 */
  logic SDFOutmux_btfPipe_vld_next;
  logic signed [19:0] dout_4_1_re_1;  /* sfix20_En15 */
  logic signed [19:0] dout_4_1_im_1;  /* sfix20_En15 */
  logic dout_4_1_vld_1;
