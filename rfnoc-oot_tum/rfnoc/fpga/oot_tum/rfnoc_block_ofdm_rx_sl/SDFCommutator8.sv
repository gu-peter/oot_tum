// -------------------------------------------------------------
// 
// File Name: /home/peter/git/ofdm-de-modulation-and-channel-estimation/IntroductionToCustomOFDMExample/hdl_rx/introOFDMReceiver/rxsl_SDFCommutator8.sv
...
// -------------------------------------------------------------
// 
// Module: rxsl_SDFCommutator8
// Source Path: introOFDMReceiver/OFDM Receiver/OFDM Demodulation/OFDM Demodulator/dsphdl.FFT/rxsl_RADIX22FFT_SDF2_8/rxsl_SDFCommutator8
// Hierarchy Level: 5
// Model version: 10.1
// 
// -------------------------------------------------------------
...
module rxsl_SDFCommutator8
          (  input logic clk,
             ...
             input logic signed [23:0] xf_re  /* sfix24_En15 */,
             input logic signed [23:0] xf_im  /* sfix24_En15 */,
             input logic xf_vld,
             input logic signed [23:0] dinf_re  /* sfix24_En15 */,
             input logic signed [23:0] dinf_im  /* sfix24_En15 */,
             input logic dinf_vld,
             input logic signed [23:0] btf1_re  /* sfix24_En15 */,
             input logic signed [23:0] btf1_im  /* sfix24_En15 */,
             input logic signed [23:0] btf2_re  /* sfix24_En15 */,
             input logic signed [23:0] btf2_im  /* sfix24_En15 */,
             input logic btfout_vld,
             output logic signed [23:0] wrData_re  /* sfix24_En15 */,
             output logic signed [23:0] wrData_im  /* sfix24_En15 */,
  ...
  logic signed [23:0] SDFCummutator_out_re;  /* sfix24 */
  logic signed [23:0] SDFCummutator_out_im;  /* sfix24 */
  logic SDFCummutator_out_vld;
  logic SDFCummutator_wrAddr_reg;  /* ufix1 */
  logic [2:0] SDFCummutator_wrState;  /* ufix3 */
  logic signed [23:0] SDFCummutator_wrData_re_reg;  /* sfix24 */
  logic signed [23:0] SDFCummutator_wrData_im_reg;  /* sfix24 */
  logic SDFCummutator_wrEnb_reg;
  logic signed [23:0] SDFCummutator_wrXData_re_reg;  /* sfix24 */
  logic signed [23:0] SDFCummutator_wrXData_im_reg;  /* sfix24 */
  ...
  logic signed [23:0] SDFCummutator_btf1_re_dly;  /* sfix24 */
  logic signed [23:0] SDFCummutator_btf1_im_dly;  /* sfix24 */
  logic SDFCummutator_btf1_vld_dly;
  logic signed [23:0] SDFCummutator_out_re_next;  /* sfix24_En15 */
  logic signed [23:0] SDFCummutator_out_im_next;  /* sfix24_En15 */
  logic SDFCummutator_out_vld_next;
  logic SDFCummutator_wrAddr_reg_next;  /* ufix1 */
  logic [2:0] SDFCummutator_wrState_next;  /* ufix3 */
  logic signed [23:0] SDFCummutator_wrData_re_reg_next;  /* sfix24_En15 */
  logic signed [23:0] SDFCummutator_wrData_im_reg_next;  /* sfix24_En15 */
  logic SDFCummutator_wrEnb_reg_next;
  logic signed [23:0] SDFCummutator_wrXData_re_reg_next;  /* sfix24_En15 */
  logic signed [23:0] SDFCummutator_wrXData_im_reg_next;  /* sfix24_En15 */
  ...
  logic signed [23:0] SDFCummutator_btf1_re_dly_next;  /* sfix24_En15 */
  logic signed [23:0] SDFCummutator_btf1_im_dly_next;  /* sfix24_En15 */
  logic SDFCummutator_btf1_vld_dly_next;
  logic signed [23:0] wrData_re_1;  /* sfix24_En15 */
  logic signed [23:0] wrData_im_1;  /* sfix24_En15 */
  logic wrAddr_1;  /* ufix1 */
  logic wrEnb_1;
  logic signed [23:0] xData_re;  /* sfix24_En15 */
  logic signed [23:0] xData_im;  /* sfix24_En15 */
  logic [2:0] wrXAddr;  /* ufix3 */
  logic wrXEnb;
  logic [2:0] rdXAddr;  /* ufix3 */
  logic xX_vld;
  logic signed [23:0] dout0_re;  /* sfix24_En15 */
  logic signed [23:0] dout0_im;  /* sfix24_En15 */
  logic dout0_vld;
  logic signed [23:0] xX_re;  /* sfix24_En15 */
  logic signed [23:0] xX_im;  /* sfix24_En15 */
  logic signed [23:0] SDFOutmux_btf2Pipe_re;  /* sfix24 */
  logic signed [23:0] SDFOutmux_btf2Pipe_im;  /* sfix24 */
  logic SDFOutmux_btfPipe_vld;
  logic signed [23:0] SDFOutmux_btf2Pipe_re_next;  /* sfix24_En15 */
  logic signed [23:0] SDFOutmux_btf2Pipe_im_next;  /* sfix24_En15 */
  logic SDFOutmux_btfPipe_vld_next;
  logic signed [23:0] dout_8_1_re_1;  /* sfix24_En15 */
  logic signed [23:0] dout_8_1_im_1;  /* sfix24_En15 */
  logic dout_8_1_vld_1;
  ...
  always_ff @(posedge clk)
    begin : SDFCummutator_process
      if (reset == 1'b1) begin
        SDFCummutator_out_re <= 24'sb000000000000000000000000;
        SDFCummutator_out_im <= 24'sb000000000000000000000000;
        SDFCummutator_wrData_re_reg <= 24'sb000000000000000000000000;
        SDFCummutator_wrData_im_reg <= 24'sb000000000000000000000000;
        SDFCummutator_wrEnb_reg <= 1'b0;
        SDFCummutator_out_vld <= 1'b0;
        SDFCummutator_wrState <= 3'b000;
        SDFCummutator_wrAddr_reg <= 1'b0;
        SDFCummutator_wrXData_re_reg <= 24'sb000000000000000000000000;
        SDFCummutator_wrXData_im_reg <= 24'sb000000000000000000000000;
        ...
        SDFCummutator_btf1_re_dly <= 24'sb000000000000000000000000;
        SDFCummutator_btf1_im_dly <= 24'sb000000000000000000000000;
  ...
  always_comb begin
    ...
    case ( SDFCummutator_XState)
      ...
      default :
        begin
          SDFCummutator_wrXData_re_reg_next = 24'sb000000000000000000000000;
          SDFCummutator_wrXData_im_reg_next = 24'sb000000000000000000000000;
          SDFCummutator_xWrAddr_next = 3'b000;
          SDFCummutator_xRdAddr_next = 3'b000;
          SDFCummutator_wrxEnb_reg_next = 1'b0;
          SDFCummutator_XState_next = 3'b000;
  ...
  always_ff @(posedge clk)
    begin : SDFOutmux_process
      if (reset == 1'b1) begin
        SDFOutmux_btf2Pipe_re <= 24'sb000000000000000000000000;
        SDFOutmux_btf2Pipe_im <= 24'sb000000000000000000000000;
