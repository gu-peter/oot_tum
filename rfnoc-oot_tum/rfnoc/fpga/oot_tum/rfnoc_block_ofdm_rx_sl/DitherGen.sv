// -------------------------------------------------------------
// 
// File Name: /home/peter/git/ofdm-de-modulation-and-channel-estimation/IntroductionToCustomOFDMExample/hdl_rx/introOFDMReceiver/DitherGen.sv
...
// 
// Module: DitherGen
// Source Path: introOFDMReceiver/OFDM Receiver/Synchronization/Synchronize/Frequency Correction/NCO HDL Optimized/DitherGen
// Hierarchy Level: 5
// Model version: 10.1
// 
...
module DitherGen
          (  input logic clk,
             ...
             input logic enb,
             input logic validIn,
             output logic [19:0] dither  /* ufix20 */);


  logic [18:0] pn_newvalue19;  /* ufix19 */
  logic [17:0] pn_newvaluesf19;  /* ufix18 */
  logic bit0_19;  /* ufix1 */
  logic bit14_19;  /* ufix1 */
  logic bit17_19;  /* ufix1 */
  logic [18:0] pn_newvalue18;  /* ufix19 */
  logic [17:0] pn_newvaluesf18;  /* ufix18 */
  logic bit0_18;  /* ufix1 */
  logic bit14_18;  /* ufix1 */
  logic bit17_18;  /* ufix1 */
  logic [18:0] pn_newvalue17;  /* ufix19 */
  logic [17:0] pn_newvaluesf17;  /* ufix18 */
  logic bit0_17;  /* ufix1 */
  logic bit14_17;  /* ufix1 */
  logic bit17_17;  /* ufix1 */
  logic [18:0] pn_newvalue16;  /* ufix19 */
  logic [17:0] pn_newvaluesf16;  /* ufix18 */
  logic bit0_16;  /* ufix1 */
  logic bit14_16;  /* ufix1 */
  logic bit17_16;  /* ufix1 */
  logic [18:0] pn_newvalue15;  /* ufix19 */
  logic [17:0] pn_newvaluesf15;  /* ufix18 */
  logic bit0_15;  /* ufix1 */
  logic bit14_15;  /* ufix1 */
  logic bit17_15;  /* ufix1 */
  ...
  logic bit18_15;  /* ufix1 */
  logic xorout15;  /* ufix1 */
  logic bit18_16;  /* ufix1 */
  logic xorout16;  /* ufix1 */
  logic bit18_17;  /* ufix1 */
  logic xorout17;  /* ufix1 */
  logic bit18_18;  /* ufix1 */
  logic xorout18;  /* ufix1 */
  logic bit18_19;  /* ufix1 */
  logic xorout19;  /* ufix1 */
  logic [18:0] pn_newvalue20;  /* ufix19 */


  assign pn_newvaluesf19 = pn_newvalue19[18:1];

  assign bit0_19 = pn_newvalue19[0];

  assign bit14_19 = pn_newvalue19[14];

  assign bit17_19 = pn_newvalue19[17];

  assign pn_newvaluesf18 = pn_newvalue18[18:1];

  assign bit0_18 = pn_newvalue18[0];

  assign bit14_18 = pn_newvalue18[14];

  assign bit17_18 = pn_newvalue18[17];

  assign pn_newvaluesf17 = pn_newvalue17[18:1];

  assign bit0_17 = pn_newvalue17[0];

  assign bit14_17 = pn_newvalue17[14];

  assign bit17_17 = pn_newvalue17[17];

  assign pn_newvaluesf16 = pn_newvalue16[18:1];

  assign bit0_16 = pn_newvalue16[0];

  assign bit14_16 = pn_newvalue16[14];

  assign bit17_16 = pn_newvalue16[17];

  assign pn_newvaluesf15 = pn_newvalue15[18:1];

  assign bit0_15 = pn_newvalue15[0];

  assign bit14_15 = pn_newvalue15[14];

  assign bit17_15 = pn_newvalue15[17];
  ...
  assign bit18_15 = pn_newvalue15[18];

  // Stage16: Compute register output and shift
  assign xorout15 = bit0_15 ^ (bit14_15 ^ (bit18_15 ^ bit17_15));

  assign pn_newvalue16 = {xorout15, pn_newvaluesf15};

  assign bit18_16 = pn_newvalue16[18];

  // Stage17: Compute register output and shift
  assign xorout16 = bit0_16 ^ (bit14_16 ^ (bit18_16 ^ bit17_16));

  assign pn_newvalue17 = {xorout16, pn_newvaluesf16};

  assign bit18_17 = pn_newvalue17[18];

  // Stage18: Compute register output and shift
  assign xorout17 = bit0_17 ^ (bit14_17 ^ (bit18_17 ^ bit17_17));

  assign pn_newvalue18 = {xorout17, pn_newvaluesf17};

  assign bit18_18 = pn_newvalue18[18];

  // Stage19: Compute register output and shift
  assign xorout18 = bit0_18 ^ (bit14_18 ^ (bit18_18 ^ bit17_18));

  assign pn_newvalue19 = {xorout18, pn_newvaluesf18};

  assign bit18_19 = pn_newvalue19[18];

  // Stage20: Compute register output and shift
  assign xorout19 = bit0_19 ^ (bit14_19 ^ (bit18_19 ^ bit17_19));

  assign pn_newvalue20 = {xorout19, pn_newvaluesf19};
  ...
  // Dither Output
  assign dither = {bit0_0, bit0_1, bit0_2, bit0_3, bit0_4, bit0_5, bit0_6, bit0_7, bit0_8, bit0_9, bit0_10, bit0_11, bit0_12, bit0_13, bit0_14, bit0_15, bit0_16, bit0_17, bit0_18, bit0_19};
