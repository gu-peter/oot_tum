// -------------------------------------------------------------
// 
// File Name: /home/peter/git/ofdm-de-modulation-and-channel-estimation/IntroductionToCustomOFDMExample/hdl_rx/introOFDMReceiver/rxsl_SDFCommutator7.sv
...
// -------------------------------------------------------------
// 
// Module: rxsl_SDFCommutator7
// Source Path: introOFDMReceiver/OFDM Receiver/OFDM Demodulation/OFDM Demodulator/dsphdl.FFT/rxsl_RADIX22FFT_SDF1_7/rxsl_SDFCommutator7
// Hierarchy Level: 5
// Model version: 10.1
// 
// -------------------------------------------------------------
...
module rxsl_SDFCommutator7
          (  input logic clk,
             ...
             input logic signed [22:0] xf_re  /* sfix23_En15 */,
             input logic signed [22:0] xf_im  /* sfix23_En15 */,
             input logic xf_vld,
             input logic signed [22:0] dinXTwdlf_re  /* sfix23_En15 */,
             input logic signed [22:0] dinXTwdlf_im  /* sfix23_En15 */,
             input logic dinxTwdlf_vld,
             input logic signed [22:0] btf1_re  /* sfix23_En15 */,
             input logic signed [22:0] btf1_im  /* sfix23_En15 */,
             input logic signed [22:0] btf2_re  /* sfix23_En15 */,
             input logic signed [22:0] btf2_im  /* sfix23_En15 */,
             input logic btf_vld,
             output logic signed [22:0] wrData_re  /* sfix23_En15 */,
             output logic signed [22:0] wrData_im  /* sfix23_En15 */,
  ...
  logic signed [22:0] SDFCummutator_out_re_next;  /* sfix23_En15 */
  logic signed [22:0] SDFCummutator_out_im_next;  /* sfix23_En15 */
  logic SDFCummutator_out_vld_next;
  logic SDFCummutator_wrAddr_reg_next;  /* ufix1 */
  logic [2:0] SDFCummutator_wrState_next;  /* ufix3 */
  logic signed [22:0] SDFCummutator_wrData_re_reg_next;  /* sfix23_En15 */
  logic signed [22:0] SDFCummutator_wrData_im_reg_next;  /* sfix23_En15 */
  logic SDFCummutator_wrEnb_reg_next;
  logic signed [22:0] SDFCummutator_wrXData_re_reg_next;  /* sfix23_En15 */
  logic signed [22:0] SDFCummutator_wrXData_im_reg_next;  /* sfix23_En15 */
  ...
  logic signed [22:0] wrData_re_1;  /* sfix23_En15 */
  logic signed [22:0] wrData_im_1;  /* sfix23_En15 */
  logic wrAddr_1;  /* ufix1 */
  logic wrEnb_1;
  logic signed [22:0] xData_re;  /* sfix23_En15 */
  logic signed [22:0] xData_im;  /* sfix23_En15 */
  logic [2:0] wrXAddr;  /* ufix3 */
  logic wrXEnb;
  logic [2:0] rdXAddr;  /* ufix3 */
  logic xX_vld;
  logic signed [22:0] dout0_re;  /* sfix23_En15 */
  logic signed [22:0] dout0_im;  /* sfix23_En15 */
  logic dout0_vld;
  logic signed [22:0] xX_re;  /* sfix23_En15 */
  logic signed [22:0] xX_im;  /* sfix23_En15 */
  logic signed [22:0] SDFOutmux_btf2Pipe_re;  /* sfix23 */
  logic signed [22:0] SDFOutmux_btf2Pipe_im;  /* sfix23 */
  logic SDFOutmux_btfPipe_vld;
  logic signed [22:0] SDFOutmux_btf2Pipe_re_next;  /* sfix23_En15 */
  logic signed [22:0] SDFOutmux_btf2Pipe_im_next;  /* sfix23_En15 */
  logic SDFOutmux_btfPipe_vld_next;
  logic signed [22:0] dout_7_1_re_1;  /* sfix23_En15 */
  logic signed [22:0] dout_7_1_im_1;  /* sfix23_En15 */
  logic dout_7_1_vld_1;
  logic [1:0] SDFCummutator_add_temp;  /* ufix2 */
  logic [1:0] SDFCummutator_add_temp_0;  /* ufix2 */
  logic [1:0] SDFCummutator_t_0;  /* ufix2 */
  logic [1:0] SDFCummutator_t_1;  /* ufix2 */
      ...
      3'b011 :
        begin
          ...
          if (SDFCummutator_wrAddr_reg == 1'b1) begin
            ...
            SDFCummutator_wrState_next = 3'b011;
            SDFCummutator_t_0 = {1'b0, SDFCummutator_wrAddr_reg};
            SDFCummutator_add_temp = SDFCummutator_t_0 + 2'b01;
